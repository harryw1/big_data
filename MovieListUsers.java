...
public class MovieListUsers{
    ...
    public static class MovieListReducer extends Reducer<IntWritable, Text, IntWritable, IntWritable>{
        ...
        public void reduce(IntWritable key, Iterable<Text> values, Context context) throws IOException, InterruptedException{
            ...
            context.write(key, new IntWritable(movie_id));
        }
    }
    ...
    public static void main(String[] args) throws Exception{
        ...
        job.setJarByClass(MovieListUsers.class);
